 ...
 <span class='home'>
  <form style='display:inline;'>
   <select onChange="if (this.value) window.location.href=this.value" style='vertical-align:text-top;'>
    <option value='form.sky'><s:txt>Language</s:txt>
...
It's most useful for residents of Canada and the US. Outside of those areas, no weather data is shown.</s:txt>
...
As a convenience, here are the results for some selected locations (Canada and US only)</s:txt>: 
...
<ul>
 ...
 <li><s:txt>a stereographic chart of the entire night sky.</s:txt>
...
<P>
 <form method='GET' action='graphic.sky' class='user-input-small' id='input_form'>
  <table>
     ...
     <tr><td><s:txt>Star chart rotation angle</s:txt>:<td>
         <select name='planisphere_rotation_angle' id='planisphere_rotation_angle' title='<s:txt>Controls the default orientation of the star chart</s:txt>'>
           <option>0
           <option>45
           <option>90
           <option>135
